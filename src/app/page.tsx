...
import  "@/assets/logo-pnf.png"
import  "@/assets/direito-consumidor.jpg"
import  "@/assets/direitos-civis.jpg"
import "@/assets/direito-familiar.jpg"
import  "@/assets/direitos-trabalhistas.jpg"
import  "@/assets/advogado-png.png"
  ...
  return (
    ...
    <section>
      ...
      <div className={styles.faleconosco}>
        <img src={"@/assets/logo-pnf.png"} alt="" />
      ...
      <div className={styles.nossotrabalho}>
        ...
        <div className={styles.direitosContainer}>
          <div className={styles.direito}>
            <img src={"@/assets/direito-consumidor.jpg"} alt="" />
          ...
          <div className={styles.direito}>
            <img src={"@/assets/direitos-civis.jpg"} alt="" />
          ...
          <div className={styles.direito}>
            <img src={"@/assets/direito-familiar.jpg"} alt="" />
          ...
          <div className={styles.direito}>
            <img src={"@/assets/direitos-trabalhistas.jpg"} alt="" />
      ...
      <div className={styles.leandroSoto}>
        ...
        <div className={styles.imagemLeandro}>
          <img src={"@/assets/advogado-png.png"} alt="" />
        </div>
      </div>
